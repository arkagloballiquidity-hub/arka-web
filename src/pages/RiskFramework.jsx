...
export default function RiskFramework() {
  ...
  const RISK_BLOCKS = isEs ? [
    {
      title: 'VaR y Control de Exposición',
      items: [
    ...
    {
      title: 'Marco de Stop de Portafolio',
      items: [
    ...
    {
      title: 'Monitoreo de Margen y Apalancamiento',
      items: [
  ...
  const hero = isEs
    ? { eyebrow: 'Marco de Riesgo', h1: 'Arquitectura de Riesgo Definida', desc: 'El rendimiento solo es significativo cuando el riesgo se mide, controla y revisa continuamente. En ARKA, la arquitectura de riesgo no es una restricción de la estrategia — es la estrategia.' }
    : { eyebrow: 'Risk Framework', h1: 'Defined Risk Architecture', desc: 'Performance is only meaningful when risk is measured, controlled, and continuously reviewed. At ARKA, risk architecture is not a constraint on strategy — it is the strategy.' }
  ...
  const ctaSecondary = isEs ? 'Explorar Estrategias' : 'Explore Strategies'
  ...
  return (
    <main className="pt-20">
      ...
      <CTASection
        ...
        title={isEs ? 'Revisa las estrategias dentro de la arquitectura de riesgo de ARKA.' : "Review strategies within ARKA's risk architecture."}
